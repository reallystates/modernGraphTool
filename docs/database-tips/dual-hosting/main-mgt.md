...
This layout keeps **modernGraphTool** at the domain root as the front page and serves CrinGraph from a subfolder. Both read the same `data/` folder. See [Dual-Hosting with CrinGraph](./index.mdx) for the other layout.
